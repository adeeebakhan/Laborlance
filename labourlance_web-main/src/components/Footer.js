  ...
  return (
    <footer className="footer p-10 bg-secondary text-base-content">
      <aside>
        ...
        <p className="text-base-100">Copyright © 2024 - All right reserved</p>
      </aside>
      <nav>
        <header className="footer-title text-primary">Quick Links</header>
        <Link className="link link-hover text-base-100" href="/">
          Home
        </Link>
        <Link className="link link-hover text-base-100" href="/about">
          About
        </Link>
        <Link className="link link-hover text-base-100" href="/jobs">
          Jobs
        </Link>
        <Link className="link link-hover text-base-100" href="/contact">
          Contact
        </Link>
      </nav>
